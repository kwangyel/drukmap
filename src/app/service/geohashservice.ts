...
export class GeohashService{
    ...
    constructor(){
        for (var i= 0; i < BASE32_CODES.length; i++) {
            this.BASE32_CODES_DICT[BASE32_CODES.charAt(i)] = i;
        }
    }
    ...
    neighbors = function(hash_string){
        ...
        function encodeNeighbor(neighborLatDir, neighborLonDir){
            ...
            return this.encode(neighbor_lat, neighbor_lon, hashstringLength);
        }
    ...
    bboxes_int = function(minLat, minLon, maxLat, maxLon, bitDepth){
        ...
        var boxNorthEast = this.decode_bbox_int(hashNorthEast, bitDepth);
