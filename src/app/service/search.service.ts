...
export class SearchService {
  ...
  searchroute(pointa,pointb){
    return this.http
      .get<any>('https://zhichar-pling.ddnsfree.com/gh/route?point='+pointa.lat +','+ pointa.lng +' &point='+pointb.lat +','+ pointb.lng +'&instructions=true&type=json&key=undefined&points_encoded=false')
      .pipe(
        catchError(this.handleError)
      );
  }
