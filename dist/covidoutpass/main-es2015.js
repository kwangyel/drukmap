...
const API_URL = 'https://outpassdashboard.desuung.org.bt/api';
...
let DashboardComponent = class DashboardComponent {
    constructor(router, dialog, dataService, snackBar, soundService) {
        this.router = router;
        this.dialog = dialog;
    ...
    login() {
        ...
        if (this.loginForm.valid) {
            ...
            this.authService.validateLogin(loginId, password).subscribe(response => {
                ...
                this.snackBar.open('Welcome Desuup ' + response.user.name, '', {
                    duration: 5000,
...
let MapComponent = class MapComponent {
    ...
    renderMap() {
        ...
        this.map.on('locationfound', (e) => {
            ...
            leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"](e.latlng, { icon: this.myMarker }).addTo(this.map).bindPopup("You are here").openPopup();
            if (radius < 100) {
                leaflet__WEBPACK_IMPORTED_MODULE_2__["circle"](e.latlng, radius).addTo(this.map);
            }
        });
    }
    onMapReady(map) {
